...
urlpatterns = [
    ...
    path('vvit/upload-s3/',          VvitUploadPDFToS3View.as_view()),
    path('vvit/institution-pdfs/',   VvitGetInstitutionPDFsView.as_view()),
    path('vvit/send-otp/',     SendOTPView.as_view()),
    path('vvit/verify-otp/',   VerifyOTPAndRegisterView.as_view()),
    path('vvit/verify-otp-only/', VerifyOTPOnlyView.as_view()),
    path('vvit/reset-password/',  ResetPasswordView.as_view()),
    path('vvit/send-otp2/',     SendOTPView2.as_view()),
